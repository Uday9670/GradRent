...
function AddFlat() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Thank you! Your flat is submitted. It should be visible in a few hours after our team verifies the images!.");
      ...
      <form onSubmit={handleSubmit} className="add-flat-form">
        ...
        <label>
          ...
          >
            ...
            <option value="CollegeA">ABESEC</option>
            <option value="CollegeB">AKGEC</option>
            <option value="CollegeC">ABESIT</option>
