...
function CollegeA() {
  ...
  const handleBookNow = (flat) => {
    // Replace with your admin WhatsApp number (international format, no + or spaces)
    const adminPhone = "919670166394"; // e.g., your admin number
